...
void user::AddAnswer(QString id_question)
{
    if(!question_my_answer.contains(id_question))
    {
        question_my_answer.push_back(id_question);
    }
...
bool user::changePassword(QString str1, QString str2)
{
    if(str1!=Password)
    {
        QMessageBox *message=new QMessageBox;
        message->setText("ÐÞ¸ÄÊ§°Ü\nÔ­ÃÜÂë´íÎó");
        message->show();
        return false;
    }
    else
